...
sSTART     db 205, 224, 247, 224, 242, 252, 32, 200, 227, 240, 243,0                    ; "Начать Игру",0
lSTART = $-sSTART

sQUIT      db 194, 251, 245, 238, 228,0                                                ; "Выход",0
lQUIT = $-sQUIT

sCREATE    db 209,238,231,228,224,242,252,32,205,238,226,251,233,32,204,232,240,33,0; Создать Новый Мир!
lCREATE = $-sCREATE-1
